...
function pageSetup(){
  ...
  var userUrl = 'https://api.github.com/users/mkparker?client_id=' +myVars.get_id()+'&client_secret='+myVars.get_secret();

  xhr(userUrl, getGithub);
}
function getGithub(obj){
  var ghH1 = document.createElement('h1'), ghImg = document.createElement('img');
...
function setVars(envs){
  ...
  // myVars.client_id = envs.clientId;
  // myVars.client_secret = envs.clientSecret;
  //console.log(myVars.client_id);
  //console.log(myVars.client_secret);
}
